        ...
        <form>
            ...
            <div class="flex-h">
                ...
                <section class="half flex-item">
                    <h3>Quality</h3>
                    <div class="row">
                        <input id="q_std" type="radio" name="quality" value="Standard" checked>
                        <label class="radio-label" for="q_std">Standard - $120/ blm</label>
                    </div>
                    <div class="row">
                        <input id="q_prem" type="radio" name="quality" value="Premium">
                        <label class="radio-label" for="q_prem">Premium - $180/ blm</label>
                    </div>
                    <div class="row">
                        <input id="q_exec" type="radio" name="quality" value="Executive">
                        <label class="radio-label" for="q_exec">Executive - $210/ blm</label>
                    </div>
                    <h3>Discount</h3>
                    <div class="row">
